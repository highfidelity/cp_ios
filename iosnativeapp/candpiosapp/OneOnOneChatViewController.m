...
- (void)keyboardWasShown:(NSNotification*)aNotification
{
    ...
    self.chatDisplay.contentInset = contentInsets;
    self.chatDisplay.scrollIndicatorInsets = contentInsets;
    ...
    if (!CGRectContainsPoint(aRect, self.activeField.frame.origin) ) {
        ...
        [self.chatDisplay setContentOffset:scrollPoint animated:YES];
    }
}
...
// The chat entry field received some data. Ship it!
- (IBAction)sendChat:(UITextField *)sender forEvent:(UIEvent *)event {
    NSString *text = [sender text];

    NSLog(@"The user typed:    %@", text);
    NSLog(@"And the event was: %@", [event description]);
}
